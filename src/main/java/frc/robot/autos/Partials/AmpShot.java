...
public class AmpShot extends SequentialCommandGroup {
   ...
   * Stop Intake
   */
  public AmpShot(Swerve s_Swerve, Arm s_Arm, Intake s_Intake, Limelight s_Limelight) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new RunCommand(() -> s_Arm.setArmPos(Constants.armAmpPOS), s_Arm).withTimeout(4.0),
